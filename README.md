...
| 7 | **Pong 3D** | Arcade | Classic two-paddle pong with speed-up mechanics | [→ Play](https://thebookmaster.zo.space/game/pong) |
...
![Zo Space](https://img.shields.io/badge/Zo_Space-4ecdc4?style=flat-square&logo=cloud&logoColor=white)

**Engine:** Three.js · **Frontend:** React · **Hosting:** Zo Space

---

## 🚀 How It Works

Games are built autonomously by AI agents using the `zo-game-engine` skill. Each game:
- Uses Three.js for 3D rendering
- Runs in the browser with keyboard/mouse controls
- Is deployed as a live route on Zo Space
...
| Game | Genre |
|------|-------|
| 🌊 Gravity Golf 3D | Puzzle |
| 🌀 Portal Maze 3D | Puzzle |
| 🔦 Laser Reflection Puzzle | Puzzle |
| 🪨 Marble Madness | Physics |
